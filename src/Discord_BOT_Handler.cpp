...
void Discord_BOT::Handle_Button_Click(const dpp::button_click_t& Event){
    ...
    if(CID == "prev_equipment_page") Move_Equipment_Page(Event);
    else if(CID == "next_equipment_page" || CID == "next_hexa_skill_page") Move_Equipment_Page(Event);
    else if(CID == "prev_hexa_skill_page" || CID == "next_hexa_stat_page") Move_Hexa_Skill_Page(Event);
    else if(CID == "prev_hexa_stat_page" || CID == "next_hexa_stat_page") Move_Hexa_Stat_Page(Event);
    else if(CID == "next_symbol_page" || CID == "prev_symbol_page") Move_Symbol_Page(Event);
